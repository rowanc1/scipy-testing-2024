...
Please submit your papers by 23:59 PST of the _1st Draft for Submission_
Deadline.
...
- Fetch the latest version of the `scipy_proceedings` repo
  - `git fetch upstream`
- Check out the upstream `2023` branch - `git checkout -b 2023 --track upstream/2023`
  .
